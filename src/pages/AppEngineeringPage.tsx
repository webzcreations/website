...
export default function AppEngineeringPage() {
  return (
    <>
      <SEOHead
        title="App Engineering"
        description="WebZ Creations builds cross-platform mobile apps using React Native. Native-feel experiences for iOS and Android from a single codebase. From concept to App Store launch."
        keywords="app development, mobile app development, React Native, cross-platform apps, iOS development, Android development, app engineering"
      />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl sm:text-6xl font-black tracking-tight text-white leading-tight">
              App <span style={{ color: "#5711C5" }}>Engineering.</span>
            </h1>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-black tracking-tight text-black dark:text-white leading-tight mb-4">
                Native-Feel Mobile Apps, One Codebase
              </h2>
              <p className="text-base text-black/50 dark:text-white/50 leading-relaxed mb-8">
                From concept to launch, we craft native-feel mobile applications using React Native.
                Your users get a premium experience on both iOS and Android from a single codebase.
              </p>
      ...
      <section className="py-28 bg-black">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-4xl sm:text-5xl font-black tracking-tight text-white leading-tight mb-6">
            Have an App Idea? <span style={{ color: "#5711C5" }}>Build It.</span>
          </h2>
