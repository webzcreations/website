  ...
  return (
    <>
      <SEOHead
        ...
        description="Boost your rankings with WebZ Creations' SEO services. Technical audits, on-page optimization, keyword research, local SEO, and content strategy for sustainable organic growth."
        keywords="SEO agency, SEO optimization, technical SEO, on-page SEO, local SEO, keyword research, content strategy, SEO services"
      />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl sm:text-6xl font-black tracking-tight text-white leading-tight">
              SEO <span style={{ color: "#5711C5" }}>Optimization.</span>
            </h1>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-base text-black/50 dark:text-white/50 leading-relaxed mb-8">
                Our SEO strategies go beyond keywords. We audit your entire digital presence, optimize
                technical infrastructure, and build content plans that drive sustainable organic growth.
              </p>
            ...
            <div className="aspect-[4/3] w-full flex items-center justify-center border border-black/10 dark:border-white/10" style={{ backgroundColor: "#5711C5" }}>
              <Search className="h-24 w-24 text-white/30" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-28 bg-black">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-4xl sm:text-5xl font-black tracking-tight text-white leading-tight mb-6">
            Boost Your Rankings. <span style={{ color: "#5711C5" }}>Let's Optimize.</span>
          </h2>
