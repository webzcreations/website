        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-4 space-y-10">
            <p className="text-base text-black/50 dark:text-white/50 leading-relaxed">
              Have a project in mind or want to consult on SEO audit frameworks? Drop us a line and let's coordinate.
            </p>

            {[
              { icon: Mail, label: "Email Us", value: "hello@webzcreations.com", href: "mailto:hello@webzcreations.com" },
              { icon: Phone, label: "Call Us", value: "+1 (555) 0199", href: "tel:+15550199" },
              { icon: MapPin, label: "Our Studio", value: "Level 5, Innovation Hub, Tech Square, NY 10011", href: "#" },
              ...
              <div key={label} className="flex items-start space-x-4">
                ...
                <div>
                  <p className="text-xs font-bold uppercase tracking-widest text-black/30 dark:text-white/30 mb-1">{label}</p>
                  <a href={href} className="text-sm font-semibold text-black dark:text-white">
                    {value}
                  </a>
                </div>
              </div>
              ...
              {!isSuccess ? (
                ...
                >
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold uppercase tracking-widest text-black/40 dark:text-white/40">Email Address</label>
                      <input
                        type="email"
                        id="email"
                        name="email"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold uppercase tracking-widest text-black/40 dark:text-white/40">Required Service</label>
                    <select
                      id="service"
                      name="service"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold uppercase tracking-widest text-black/40 dark:text-white/40">Message</label>
                    <textarea
                      id="message"
                      name="message"
                      rows={5}
                ...
                >
                  <div className="w-12 h-12 flex items-center justify-center text-white" style={{ backgroundColor: "#5711C5" }}>
                  ...
                  <p className="text-base text-black/50 dark:text-white/50 max-w-sm leading-relaxed">
                    Thank you for reaching out. Our team will follow up within 24 business hours.
                  </p>
                  <button
